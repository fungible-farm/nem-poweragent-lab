...
# (nperseg-noverlap = 50-sample step, 10 ms) -- fine enough time resolution to
# see the fault onset/clearing edges as distinct events, coarse enough for a
# stable frequency estimate of the 50 Hz fundamental (fs/nperseg = 20 Hz bin
# spacing).
